...
//end-to-end test　実際の使用方法をシュミレートする
...
class TasksActivityTest {
    ...
    //データバインディングの終了(uiの更新が終わってアイドル状態であること)を確認する
    ...
    //アプリがアイドル状態になる前(動作中)にチェックが入るとテストが失敗する可能性がある(EspressoはUI更新が終了しているか判断できない)
    //IdlingResourceを追加してアイドル状態を判断できるようにする
    @Test
